...
Our current work involves a stability and testing release (`v0.1.5`) to solidify the existing codebase. The complete **Development Roadmap & Versioning Plan**, which tracks our progress version by version, is available in the **[ROADMAP.md](ROADMAP.md)** file and **[Issue #23](https://github.com/brianmsm/psymetrics/issues/23)**.
