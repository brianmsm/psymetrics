...
#'
#' @description
#' `print.model_fit` is a custom print method for objects
#' generated by the [`model_fit`] function. It formats the
#' output table using [`insight::format_table`] and exports
#' it using [`insight::export_table`].
#'
...
#'   - If `format = "text"` or `format = "markdown"` they
#'     are passed to [`insight::export_table`].
